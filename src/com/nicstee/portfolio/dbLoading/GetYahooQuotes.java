...
public class GetYahooQuotes {
    ...
    public void downloadQuote(String symbol, long startDate, long endDate, String crumb) {
        ...
        downloadData(url, symbol, startDate, endDate, crumb);
    }
 
    public void downloadDividends(String symbol, long startDate, long endDate, String crumb) {
      String url = String.format("https://query1.finance.yahoo.com/v7/finance/download/%s?period1=%s&period2=%s&interval=1d&events=div&crumb=%s", symbol, startDate, endDate, crumb);
      downloadData(url, symbol, startDate, endDate, crumb);   	
    }


    public void downloadData(String url, String symbol, long startDate, long endDate, String crumb) {
